...
import {
  ...
  Home, Scale, Car, Scissors, PawPrint, Settings, ShoppingBag, Palette, Compass, Footprints
} from 'lucide-react'
...
const categories = [
  ...
  { name: 'Churches & Community', slug: 'churches-community',   icon: Church,          color: '#7c3aed', bg: '#faf5ff' },
  { name: 'Real Estate',          slug: 'real-estate-rentals',  icon: Home,            color: '#ea580c', bg: '#fff7ed' },
  { name: 'Events',               slug: 'events',               icon: CalendarDays,    color: '#db2777', bg: '#fdf2f8' },
  { name: 'Legal & Financial',    slug: 'legal-financial',      icon: Scale,           color: '#0891b2', bg: '#ecfeff' },
  { name: 'Transportation',       slug: 'transportation',       icon: Car,             color: '#65a30d', bg: '#f7fee7' },
  ...
  { name: 'Auto Services',        slug: 'auto-services',        icon: Settings,        color: '#475569', bg: '#f8fafc' },
  { name: 'Shopping & Retail',    slug: 'shopping-retail',      icon: ShoppingBag,     color: '#9333ea', bg: '#faf5ff' },
  { name: 'Arts & Education',     slug: 'arts-education',       icon: Palette,         color: '#0d9488', bg: '#f0fdfa' },
  { name: 'Tours & Entertainment',slug: 'tours-entertainment',  icon: Compass,         color: '#0369a1', bg: '#e0f2fe' },
  { name: 'Walking Downtown',       slug: 'walking-downtown',    icon: Footprints,      color: '#b45309', bg: '#fffbeb' },
]
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', paddingBottom: '80px' }}>
      ...
      <div style={{ backgroundColor: '#0f3460', padding: '28px 20px 36px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', marginTop: '16px', position: 'relative' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.6)' }}>150+ businesses</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <div style={{ width: '6px', height: '6px', backgroundColor: '#fbbf24', borderRadius: '50%' }} />
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.6)' }}>15 categories</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: '24px 20px 0' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
          {categories.map(({ name, slug, icon: Icon, color, bg }) => (
            <Link key={slug} href={'/category/' + slug} style={{ backgroundColor: 'white', borderRadius: '16px', padding: '16px 14px', display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none', minHeight: 0, height: 'auto', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', border: '1px solid #f1f5f9' }}>
      ...
      <div style={{ padding: '32px 20px 16px', textAlign: 'center' }}>
        <div style={{ fontSize: '12px', color: '#94a3b8' }}>
          Powered by{' '}
          <a href='https://klickifyagency.com' target='_blank' rel='noopener noreferrer' style={{ color: '#e94560', fontWeight: 600, textDecoration: 'none', display: 'inline', minHeight: 0, height: 'auto' }}>Klickify Agency</a>
        </div>
      </div>
      <BottomNav />
    </div>

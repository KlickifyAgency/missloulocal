  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', paddingBottom: '80px' }}>
      ...
      <div style={{ padding: '48px 20px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 700, color: '#0f172a', margin: '0 0 12px' }}>Today's Deals</h2>
        <p style={{ fontSize: '16px', color: '#64748b', margin: '0 0 32px', lineHeight: 1.6 }}>Exclusive deals and discounts from local businesses in Natchez.</p>

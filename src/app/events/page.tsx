    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', paddingBottom: '80px' }}>
      ...
      <div style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{ backgroundColor: '#eff6ff', borderRadius: '16px', padding: '16px', border: '1px solid #bfdbfe', marginTop: '8px' }}>
          ...
          <p style={{ fontSize: '13px', color: '#3b82f6', margin: 0 }}>Email us at <a href='mailto:events@missloulocal.com' style={{ color: '#1e40af', fontWeight: 600 }}>events@missloulocal.com</a> and we will add it to the calendar.</p>
        </div>
      </div>

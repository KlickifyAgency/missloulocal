  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f8fafc', paddingBottom: '80px' }}>
      ...
      <div style={{ padding: '48px 20px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 700, color: '#0f172a', margin: '0 0 12px' }}>Local Events</h2>
        <p style={{ fontSize: '16px', color: '#64748b', margin: '0 0 32px', lineHeight: 1.6 }}>Stay up to date with events happening in Natchez and the Miss-Lou area.</p>
